      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            标签：
            <el-button @click="tagOrCategory('tag', t.id)" size="mini" type="primary" v-for="t in article.blogTagList" :key="t.id" round plain>{{t.tagname}}</el-button>
          </div>

          <div class="me-view-tag">
            文章分类：
            <el-button @click="tagOrCategory('category', article.blogCategory.id)" size="mini" type="primary" round plain>{{article.blogCategory.categoryname}}</el-button>
          </div>
    ...
    methods: {
      ...
      getArticle() {
        ...
        viewArticle(that.$route.params.id).then(data => {
          Object.assign(that.article, data.result)
          that.article.editor.value = data.result.content
