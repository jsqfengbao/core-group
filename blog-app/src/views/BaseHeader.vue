      ...
      <el-col :span="4">
        <el-menu :router=true menu-trigger="click" mode="horizontal" active-text-color="#5FB878">
          ...
          <template v-if="!user.login">
            <!--<el-menu-item index="">-->
              <!--<el-button type="text"><a href="http://localhost:3000/user/login?redirect=%2F" target="_self">登录</a></el-button>-->
...
<script>
  import {getUserInfo,getToken} from "@/request/token";
